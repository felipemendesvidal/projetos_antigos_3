...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		PluginSettings.Add("ImageResize_smallThumb", "270x270" );
		PluginSettings.Add("ImageResize_mediumThumb", "270x270" );
		PluginSettings.Add("ImageResize_largeThumb", "270x270" );
		// Name of the watermark image in plugins/watermark folder
		PluginSettings.Add("Watermark_source", "logo.gif" );
		PluginSettings.Add("Watermark_marginRight", "0" );
		PluginSettings.Add("Watermark_marginBottom", "0" );
		PluginSettings.Add("Watermark_quality", "400" );
		...
		Thumbnails.Url = BaseUrl + "Miniaturas/";
		if ( BaseDir != "" ) {
			Thumbnails.Dir = BaseDir + "Miniaturas/";
		}
		Thumbnails.Enabled = true;
		Thumbnails.DirectAccess = false;
		Thumbnails.MaxWidth = 170;
		Thumbnails.MaxHeight = 170;
		...
		type = ResourceType.Add( "Documentos" );
		type.Url = BaseUrl + "Documentos/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Documentos/";
		type.MaxSize = 0;
		...
		type.Url = BaseUrl + "Fotos/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Fotos/";
		type.MaxSize = 0;
